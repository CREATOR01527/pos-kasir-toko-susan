...
3. Jalankan juga `supabase/migration-02-fitur-tambahan.sql`, lalu `supabase/migration-03-perbaikan.sql`, lalu `supabase/migration-04-harga-bertingkat.sql`, lalu `supabase/migration-05-retur-dan-metode-bayar.sql`, lalu `supabase/migration-06-barcode-unik-dan-nota.sql` (satu kali, berurutan).
