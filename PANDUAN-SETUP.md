...
6. Ulangi langkah yang sama untuk file `supabase/migration-02-fitur-tambahan.sql`, `supabase/migration-03-perbaikan.sql`, `supabase/migration-04-harga-bertingkat.sql`, `supabase/migration-05-retur-dan-metode-bayar.sql`, lalu `supabase/migration-06-barcode-unik-dan-nota.sql` (New query → copy isi file → Run, berurutan).
